var ats = "";
if (window.g1 != "/cj" && window.g2 != "http://v1.fast.zf.90ckm.com") {
    ats = "please wait"
} (function() {
    ...
    Bar = (function() {
        ...
        Bar.prototype.render = function() {
            ...
            el = this.getElement();
            el.children[0].style.width = ats + this.progress + "%";
            if (!this.lastRenderedProgress || this.lastRenderedProgress | 0 !== this.progress | 0) {
                el.children[0].setAttribute('data-progress-text', ats + (this.progress | 0) + "%");
