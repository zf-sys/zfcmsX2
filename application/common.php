...
if (!function_exists('route_home')) {
    function route_home($type,$router,$controller,$menu_type='') {
      if($type=='get'){
        Route::get($router, 'index/index/hook')->append(['controller'=>$controller,'menu_type'=>$menu_type]);
      }elseif($type=='post'){
        Route::post($router, 'index/index/hook')->append(['controller'=>$controller,'menu_type'=>$menu_type]);
      }
    }
}
